                        ...
                        <div className='dialog-content'>
                            <div className='flex flex-col'>
                                <div className='flex justify-between'>
                                    <div className='p-3 border borde-gray-200 rounded-10'>
                            ...
                            <form className='flex flex-col mt-5' onSubmit={handleSubmit}>
                                ...
                                <div className='dialog-input_container'>
                                    ...
                                    <input required type="email" id="email" placeholder='Enter your email address' value={email} onChange={(e) => setEmail(e.target.value)} className='dialog-input' />
                                </div>
